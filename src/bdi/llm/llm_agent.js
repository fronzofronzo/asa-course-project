...
// At each call to the LLM we want to do, we simply call this function
...
// Conversation memory - it stores only the questions and the final answers given by the llm
const messages = [
  {
    role: "system",
...
// Agent loop for one user request
...
console.log("First LLM agent implementation: DeliverooJS + tools execution loop started.");
